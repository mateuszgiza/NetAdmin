...
define('configuration',["require", "exports"], function (require, exports) {
    ...
    var Configuration = (function () {
        ...
        Configuration.Configure = function (http) {
            var _this = this;
            http.configure(function (cfg) {
                cfg
                    .useStandardConfiguration()
                    .withBaseUrl(_this.apiUrl)
                    .withDefaults({
                    headers: {
...
define('issues/index',["require", "exports", 'aurelia-framework', 'aurelia-router', 'aurelia-fetch-client', './../configuration'], function (require, exports, aurelia_framework_1, aurelia_router_1, aurelia_fetch_client_1, configuration_1) {
    "use strict";
    var Index = (function () {
        function Index(http, router) {
            ...
            this.http = http;
            this.router = router;
            configuration_1.Configuration.Configure(this.http);
        }
        ...
        Index.prototype.show = function (id) {
...
define('issues/Models/Issue',["require", "exports", "../enums", "../../helpers/enum-ext"], function (require, exports, enums_1, enum_ext_1) {
    "use strict";
    var Issue = (function () {
        function Issue() {
            this.issueTypes = enum_ext_1.EnumExt.getNamesAndValues(enums_1.IssueType);
        }
        return Issue;
    }());
    exports.Issue = Issue;
...
define('issues/new',["require", "exports", "aurelia-framework", "aurelia-fetch-client", "aurelia-router", './../configuration', "./Models/Issue"], function (require, exports, aurelia_framework_1, aurelia_fetch_client_1, aurelia_router_1, configuration_1, Issue_1) {
    "use strict";
    var New = (function () {
        function New(http, router) {
            var _this = this;
            this.heading = "Issues";
            this.model = new Issue_1.Issue();
            this.send = function () {
...
define('issues/show',["require", "exports", 'aurelia-framework', 'aurelia-fetch-client', 'aurelia-router', "../configuration"], function (require, exports, aurelia_framework_1, aurelia_fetch_client_1, aurelia_router_1, configuration_1) {
    "use strict";
    var Show = (function () {
        function Show(httpClient, router) {
            this.http = httpClient;
            this.router = router;
            configuration_1.Configuration.Configure(this.http);
        }
        Show.prototype.activate = function (params, routeConfig, $navigationInstruction) {
            var _this = this;
            this.issueId = params.id;
            return this.http.fetch('issues/' + this.issueId)
                .then(function (response) { return response.json(); })
                .then(function (res) {
                _this.exist = res.exist;
                _this.issue = res.issue;
            });
        };
        Show.prototype.delete = function (id) {
            var _this = this;
            this.http.fetch('issues/' + id, {
                method: 'delete'
            }).then(function (i) { return _this.router.navigate("issues"); });
        };
        Show = __decorate([
            aurelia_framework_1.inject(aurelia_fetch_client_1.HttpClient, aurelia_router_1.Router), 
            __metadata('design:paramtypes', [Object, Object])
...
define('text!issues/show.html', ['module'], function(module) { module.exports = "<template>\r\n\r\n    <require from=\"./../helpers/converters\"></require>\r\n\r\n    <span class=\"tag tag-default lower\">\r\n        <i class=\"fa fa-fw fa-tag\"></i>\r\n        ${issue.issueType | issueTypeFormat}\r\n    </span>\r\n\r\n    <h4>\r\n         ${issue.title}\r\n    </h4>\r\n    <p>${issue.text}</p>\r\n\r\n    <p>Created at ${issue.creationDate}</p>\r\n    <p if.bind=\"issue.modificationDate != null\">Modified at ${issue.modificationDate}</p>\r\n\r\n    <button class=\"btn btn-sm btn-warning\" disabled>\r\n        <i class=\"fa fa-fw fa-pencil\"></i> Edit\r\n    </button>\r\n    <button class=\"btn btn-sm btn-danger\" click.trigger=\"delete(issue.id)\">\r\n        <i class=\"fa fa-fw fa-trash\"></i> Delete\r\n    </button>\r\n\r\n</template>"; });
